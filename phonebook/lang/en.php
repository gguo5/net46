<?php
	...
	$TEXT['xampp-setup-notok'] = "<br><br>ERROR: The string for the user name and password must be 3 to 15 characters long. Special characters like <��� (usw.) and empty characters are not allowed!<br><br>";
	...
	$TEXT['phonebook-sure'] = "Are you sure to delete this entry? Change can not be reverted.";
        $TEXT['phonebook-delele-all-sure'] = "DANGER!! Are you sure to delete all entries?";
	$TEXT['phonebook-head2'] = "Add entry";
	$TEXT['phonebook-button1'] = "DELETE";
        $TEXT['phonebook-button1-all'] = "DEL ALL";
